...
-- -----------------------------------------------------
-- Table `mydb`.`Priviledge`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Priviledge` (
...
-- -----------------------------------------------------
-- Table `mydb`.`Partition type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Partition type` (
  `idPartition type` VARCHAR(45) NOT NULL,
  `Shelves` INT NULL,
  `Box` INT NULL,
  PRIMARY KEY (`idPartition type`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `mydb`.`Placement_has_Partition type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Placement_has_Partition type` (
  `Placement_idPlacement` VARCHAR(45) NOT NULL,
  `Partition type_idPartition type` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`Placement_idPlacement`, `Partition type_idPartition type`),
  INDEX `fk_Placement_has_Partition type_Partition type1_idx` (`Partition type_idPartition type` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Placement_has_Partition type_Partition type1`
    FOREIGN KEY (`Partition type_idPartition type`)
    REFERENCES `mydb`.`Partition type` (`idPartition type`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`User_has_Priviledge` (
  ...
  CONSTRAINT `fk_User_has_Priviledge_Priviledge1`
    ...
    REFERENCES `mydb`.`Priviledge` (`Priviledge`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
